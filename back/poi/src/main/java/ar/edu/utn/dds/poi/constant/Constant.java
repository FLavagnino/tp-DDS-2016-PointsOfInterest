...
public class Constant
{
    ...
    // Web Service
    public final static String BANK_SEARCH_URL = "http://localhost:8080/Consultas/banco";
    ...
    public final static String CGP_SEARCH_URL = "http://localhost:8080/Consultas/centro";
